...
def mode_penjual():
    ...
    while True:
        ...
        pilihan = input("\nPilih Menu (ketik 'keluar' untuk keluar dari mode penjual) : ")
        if pilihan.lower() == '1':
            menambahkan_barang()
...
def menambahkan_barang():
    ...
    while True: 
        kode_barang = input('Masukan kode Barang atau ketik "keluar" untuk keluar : ')
        
        if kode_barang.lower() == "keluar":
            print("Keluar dari menu menambahkan barang")
            break
